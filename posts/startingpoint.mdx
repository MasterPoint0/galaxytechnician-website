---
title: StartingPoint Discord Server
description: "Starting Point is a custom discord server that is built explicitly for roleplaying. Achieve the highest point."
date: Nov 19 2022
---

Starting Point is a custom discord server that is built explicitly for roleplaying. Achieve the highest point.
> ...Knowledge is power...
...
| Option | Description                                                               |
| ------ | ------------------------------------------------------------------------- |
| galaxytechnician   | discord server owner and developer. |
| cygnus | programmer and helper.    |
| kiarra2240    | discord server moderator and owner.                                      |

## Links

Support Us, Join https://discord.gg/j4637yKNuX
